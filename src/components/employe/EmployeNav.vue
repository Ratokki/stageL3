...
const links = [
  { text: "Mes tâches", icon: "mdi-clipboard-check-outline", route: '/employe/Tache' }, // Route pour Utilisateur
  { text: "Rapport quotidien", icon: "mdi-note-text-outline", route: '/employe/Rapport' }, // Route pour Gestion du projet
  { text: "Discussion", icon: "mdi-message-text-outline", route: '/employe/Discussion' },
];
