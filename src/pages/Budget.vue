  ...
  <v-app :style="{ backgroundColor: '#F4F5FA', fontFamily: 'ABeeZee' }">
    ...
    <v-main>
      ...
      <v-container fluid class="px-6 mt-n2" style="">
       ...
       <v-col cols="12">
  <span style="margin-left: 15px; font-size: 20px;">Projets acceptés récents de cette semaine</span>
  <v-row style="margin-top: 8px;">
    ...
    >
      <v-card>
        ...
        <v-card-subtitle>Accepté le: {{ project.dateAccept }}</v-card-subtitle>
        <v-card-subtitle>Proposé le: {{ project.proposDate }}</v-card-subtitle>
        <v-card-text>
          <p>Statut: {{ project.status }}</p>
          <p>Description: {{ project.descr }}</p>
        </v-card-text>
        <v-card-actions>
          <v-btn @click="openAssignModal(project)">Assigner</v-btn>
        </v-card-actions>
      </v-card>
    </v-col>
    <v-col v-if="recentAcceptedProjects.length === 0">
      <p>Aucun projet accepté récent trouvé.</p>
                      ...
                      <v-col cols="12" style="margin-top: 20px;">
                        <span style="margin-left: 15px; font-size: 20px;">Tous les projets acceptés</span>
                        <v-row style="margin-top: 8px;">
                          <v-col
